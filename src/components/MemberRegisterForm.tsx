        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex shrink-0 items-center rounded border border-amber-900/20 bg-white/50 px-4 py-3 text-base text-gray-900 hover:bg-amber-50 focus:ring-2 focus:ring-amber-900/30 focus:outline-none disabled:opacity-50">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <select
              ...
              className="w-full rounded border border-amber-900/20 bg-white/50 px-3 py-3 text-base text-gray-900 focus:ring-2 focus:ring-amber-900/30 focus:outline-none">
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex shrink-0 items-center gap-1 rounded border border-amber-900/20 bg-white/50 px-4 py-3 text-base text-gray-900 hover:bg-amber-50 focus:ring-2 focus:ring-amber-900/30 focus:outline-none">
