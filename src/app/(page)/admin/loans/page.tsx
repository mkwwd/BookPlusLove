    ...
    <div className="space-y-4">
      ...
      <div className="border-t border-amber-900/10 pt-4">
        ...
        <button
          ...
          className="w-full rounded border border-amber-900/30 bg-white px-5 py-2.5 text-base font-medium text-gray-900 transition hover:bg-amber-50 disabled:opacity-50">
          ...
          <tbody className="divide-y divide-amber-900/10">
            {isLoansLoading ? (
              ...
              visibleLoans.map((loan) => (
                <tr key={loan.id}>
                  <td className="px-5 py-3 text-gray-900">{loan.title}</td>
                  ...
                  <td className="px-5 py-3 text-gray-700">{loan.dueAt}</td>
